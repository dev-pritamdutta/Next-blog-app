          ...
          <div className="flex items-center space-x-3">
            <div className="relative">
              <button
                ...
                className="p-2 rounded-full text-gray-500 hover:text-primary cursor-pointer transition-colors focus:outline-none"
              >
                <BsSearch size={18} />
              </button>
              {isSearchOpen && (
            ...
            <Link
              href="/contact"
              className="px-5 py-1.5 border border-gray-300 text-gray-800 rounded-md hover:bg-green-600 hover:text-white trasition-colors focus:outline-none focus:ring-2 focus:ring-primary cursor-pointer"
            >
              Contact
            </Link>
            ...
            <SignedOut>
              <SignInButton mode="modal">
                <button className="px-5 py-2 border border-gray-300 bg-green-600 text-white rounded-md hover:bg-green-700 hover:text-white trasition-colors focus:outline-none focus:ring-2 focus:ring-primary cursor-pointer">
                  Sign In
                </button>
              </SignInButton>
            </SignedOut>
